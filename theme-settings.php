...
function adventure4life_form_system_theme_settings_alter(&$form, &$form_state) {

  $theme = \Drupal::theme()->getActiveTheme()->getName();

  $form['adventure4life'] = array(
    '#type' => 'vertical_tabs',
  ...
  $form['debug'] = array(
    ...
    '#weight' => -699,
    '#group' => 'adventure4life',
  );

  $form['adventure4life_block_demo_mode'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('adventure4life_block_demo_mode', $theme),
    '#group' => 'debug',
  );
  ...
  $form['#validate'][] = 'adventure4life_disable_twig_cache';

}

function adventure4life_disable_twig_cache(&$form, \Drupal\Core\Form\FormStateInterface $form_state) {
